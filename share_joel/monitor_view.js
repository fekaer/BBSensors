function monitorFunction(document, io) {
    "use strict";
    ...
    function drawWave() {
        ...
        function Signal(position, info, signals, color, scaleFunction) {
            ...
            const _this = this;
            this.socket = io.connect('http://129.194.184.60:8085');
        ...
        new Signal(0, "BPM1", ["bpm1_flow", "bpm1_sec"], "green", function (value) {
            return minMaxDraw(positionTopY(0), parseInt(-value) / 200 + positionCenterY(0), positionBottomY(0) - 1);
        });

        new Signal(1, "BPM2", ["bpm2_flow", "bpm2_sec"], "blue", function (value) {
            return minMaxDraw(positionTopY(1), parseInt(-value) / 2000 + positionCenterY(1), positionBottomY(1));
        });
